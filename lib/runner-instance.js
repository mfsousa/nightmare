...
function RunnerInstance(parent,inProcessOptions)
{
    ...
    function initWindow(done)
    {
        ...
        if (isWebView)
          windowIpc.addEventListener(buildChannelName('page'),onPageEvent)
        else
          windowIpc.on(buildChannelName('page'),onPageEvent)

        function onConsoleEvent()
        {
          var type,args;
          if (isWebView)
          {
        ...
        if (isWebView)
          windowIpc.addEventListener(buildChannelName('console'),onConsoleEvent)
        else
